...
contract StarNotary is ERC721 {
    ...
    string public name = "Cleyton StarNotary";
    string public symbol = "CSN";

    /*
    constructor() public ERC721("Cleyton StarNotary", "CSN") {

    }

    constructor() ERC721("Cleyton StarNotary", "CSN") {
    ...
    */
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "You're not the owner of this star");
